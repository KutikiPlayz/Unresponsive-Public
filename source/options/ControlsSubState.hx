...
class ControlsSubState extends MusicBeatSubstate {
	...
	override function update(elapsed:Float) {
		OptionsState.optionsDisplacementFilter.scaleX = FlxG.random.float(-10, 10);
		OptionsState.optionsDisplacementFilter.mapPoint = new Point(0, FlxG.random.float(-15, 15));
